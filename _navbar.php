<?php
    ...
    if (empty($_SESSION['classification'])) {
    ...
    } else if ($_SESSION['classification'] == "ORGOFFICER") {
        echo '
        <nav class="navbar sticky-top navbar-dark bg-primary navbar-expand-lg" style="margin-bottom: 32px">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">CSO - APSMS</a>
        ...
        ';
        if ($_SERVER['SCRIPT_NAME'] == '/index.php' || $_SERVER['SCRIPT_NAME'] == '/dts.php' || $_SERVER['SCRIPT_NAME'] == '/view.php' || $_SERVER['SCRIPT_NAME'] == '/actDetails.php' ) {
