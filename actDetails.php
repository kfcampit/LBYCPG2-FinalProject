...
<body style = "margin: 50px;">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <br><br>
        <label for = "start_Date"> Starting Date: </label><input type="text" name="start_Date" placeholder="YYYY-MM-DD" pattern="[0-2023]{3}-[0-12]{2}-[0-31]{3}">
        <span class="error">* <?php echo $start_DateErr;?></span>

        <br><br>
        <label for = "end_Date"> Ending Date: </label><input type="text" name="end_Date" placeholder="YYYY-MM-DD" pattern="[0-2023]{3}-[0-12]{2}-[0-31]{3}">
        <span class="error">* <?php echo $end_DateErr;?></span>

        <br><br>
        <label for = "time"> Time: </label><input type="text" name="time" placeholder="HH-MM-SS" pattern="[0-12]{3}-[0-60]{2}-[0-60]{3}">
